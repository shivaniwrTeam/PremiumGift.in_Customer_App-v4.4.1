...
class AppSettings {
  ...
  static const String baseUrl =
      'https://eshopweb.store/app/v1/api/'; // Base API endpoint
  static const String chatBaseUrl =
      "https://eshopweb.store/app/v1/Chat_Api/"; // Chat-specific API endpoint
  ...
  static const String shareNavigationWebUrl =
      "eshop.wrteam.co.in"; // Web URL for sharing navigation
